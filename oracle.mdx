...
<CardGroup cols={2}>
  ...
  <Card title="TheSportsDB" icon="database" href="https://thesportsdb.com">
    **Event Metadata**

    Team names and schedules come from TheSportsDB. This data is for display only—not used for resolution.
  </Card>
</CardGroup>
